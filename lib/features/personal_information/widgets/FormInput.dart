...
class _InputFromState extends State<Forminput> {
  ...
  void handlePutLegalName(String firstName, String lastName) async {
    if (_formKey.currentState!.validate()) {
      try {
        LegalNameRequest request =
            LegalNameRequest(firstName: firstName.trim(), lastName: lastName.trim());
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController firstNameController =
        TextEditingController(text: utf8.decode(user!.firstName.codeUnits));
    TextEditingController lastNameController =
        TextEditingController(text: utf8.decode(user!.lastName.codeUnits));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          !isShowInput
              ? Text("${utf8.decode(user.firstName.codeUnits)} ${utf8.decode(user.lastName.codeUnits)}")
              : Container(
                  child: Form(
                  key: _formKey,
                  child: Column(
