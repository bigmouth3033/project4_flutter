...
import 'package:project4_flutter/shared/models/transaction.dart';
...
class TransactionCubit extends Cubit<TransactionState> {
  ...
  bool _validateTransactionData(Transaction transaction) {
    return transaction.bookingId != null &&
  ...
  Future<Transaction?> createTransaction(Transaction transaction) async {
    ...
    try {
      ...
      final response =
      await apiService.post("transaction/booking_escrow", body: transaction.toJson());
